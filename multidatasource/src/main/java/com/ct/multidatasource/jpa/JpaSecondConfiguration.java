...
@Configuration
//实体扫面
@EntityScan(basePackages = "com.ct.multidatasource.jpa.second.domain")
//1、repository扫描
//2、实体管理ref
//3、事务管理
@EnableJpaRepositories(
        basePackages = "com.ct.multidatasource.jpa.second.repository",
...
public class JpaSecondConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        return factoryBuilder.dataSource(dataSource)
                ...
                .packages("com.ct.multidatasource.jpa.second.domain")
