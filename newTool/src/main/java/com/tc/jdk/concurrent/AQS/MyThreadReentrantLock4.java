...
public class MyThreadReentrantLock4 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            t1.start(); // t1开始
            Thread.sleep(2000); // 模拟线程t1执行一段时间，完成了任务
            t1.interrupt(); // 中断t1
...
//        at com.tc.jdk.concurrent.AQS.MyThreadReentrantLock4.lambda$main$0(MyThreadReentrantLock4.java:18)
