...
//        test1();
    ...
    private static void test1() throws IOException {
        ...
        new Thread(() -> {
            ...
            // 如果是async的，则会交给ForkJoinPool.commonPool中线程去处理
            f.complete(100);
        ...
        f.whenCompleteAsync((i, ex) -> {
            ...
            try {
                logger.info("沉睡10s "  + Thread.currentThread().getName() + "。 value:" + i);
                Thread.sleep(10000);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
...
//        2023-05-12 14:13:43.394  [Thread-0] INFO  com.tc.jdk.concurrent.completableFuture.AsyncAndSyncTest Line:55  - 沉睡10s Thread-1。 value:100
...
//        2023-05-12 14:13:53.395  [Thread-0] INFO  com.tc.jdk.concurrent.completableFuture.AsyncAndSyncTest Line:42  - 子线程A结束 Thread-0
    ...
    private static void test2() throws IOException {
        ...
        f.whenCompleteAsync((i, ex) -> {
            ...
            logger.info("沉睡10s "  + Thread.currentThread().getName() + "。 value:" + i); // 虽然有主线程执行，也能拿到i的值100
            try {
...
//        2023-05-12 14:21:23.103  [main] INFO  com.tc.jdk.concurrent.completableFuture.AsyncAndSyncTest Line:102 - 沉睡10s main。 value:100
